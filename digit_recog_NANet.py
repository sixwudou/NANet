...
with tf.Session() as sess:
  ...
  if my_file.is_file():
      ...
      if answer in ['y', 'Y', 'yes', 'Yes', 'YES']:
            ...
            sum_steps = input("Number of extra training steps:")
            ...
            save_path = saver.save(sess, "modelsNaNet/NANet_model_%s_%s" % (max_steps,eta))
      ...
      for step in range(max_steps):
        ...
        if step % 1000 == 0:
          ...
          file = open("digit_recog_NaNet_results.txt","a")
